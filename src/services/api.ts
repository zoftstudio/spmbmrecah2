...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxABPKhHHdYHATixypjf5ecBJmTti5quYJPjp31VZp5PFat93YSfiw5nkx1ZX-Rid4L/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  ...
  return {
    ...
    alamat: "Jl. Raya Mrecah, Ds. Mrecah, Kec. Tanah Merah, Kab. Bangkalan",
